...
if __name__ == '__main__':
    ...
    queries = [query_cliente, query_pedidos, query_produto, query_pagamento, query_tempo_data
               ,query_tempo_instante, query_fato_pedido, insert_cliente, insert_pedido, insert_produto, insert_pagamento, insert_tempo_data,
